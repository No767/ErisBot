...
class Image(commands.Cog):
    ...
    async def slap(self, ctx, member: discord.Member):
        discord.File("./cogs/ImageFolder/batslap.png")
        ...
        with io.BytesIO() as image_binary:
            ...
            await ctx.message.channel.send(
                file=discord.File(fp=image_binary, filename="batslap.png")
            )
    ...
    async def jail(self, ctx, member: discord.Member):
        ...
        with io.BytesIO() as image_binary:
            ...
            image_binary.seek(0)
            await ctx.message.channel.send(
                file=discord.File(fp=image_binary, filename="jail.png")
            )
    ...
    async def podium(self, ctx, *members: discord.Member):
        ...
        with io.BytesIO() as image_binary:
            ...
            image_binary.seek(0)
            await ctx.message.channel.send(
                file=discord.File(fp=image_binary, filename="podium.png")
            )
